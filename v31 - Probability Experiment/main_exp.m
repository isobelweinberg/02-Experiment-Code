try
    ...
    vars.TMS.Timepoints = [0, 0.3]; %TMS timepoints, in SECONDS, relative to Timepoint Relations... 
    %NB if scaling to RT, give the timepoints relative to stim as
    %proportion of mean RT e.g. 0.65
    vars.TMS.TimepointRelations = {'Stim', 'Stim'}; %....Fixation, Stim or ITI %NB this must match the numel in timepoints or a shitstorm occurs
