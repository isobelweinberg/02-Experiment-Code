...
%     t_vars.TrialsPerCondition = 20; %?
    ...
    waitforpress(t_option, t_params)
     ...
     t_vars.Thresholds = 0.8;
     t_vars.ThresholdPriors = 16.8;
...
%     t_vars.TMS.Timepoints = [0.05, 0.1, 0.2];
    ...
    for thresholdblock = 1:numel(t_vars.Thresholds)
        ...
        for k=1:trialsDesired
            ...
            TrialsPerBlock = 1;
            timeSplit=GetSecs;
            [t_FixationXY, t_DotsXY, t_data, t_vars, t_schedule] = generate_stimuli(NumTrials, t_vars, t_params, t_option, t_data, participant);
