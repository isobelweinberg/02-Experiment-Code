try
    ...
    train_vars.LeftProbabilityArray = [10, 25, 50]; %probability the RDK goes left, as a percentage
    train_vars.CoherenceArray = 20; %use 20% coherence - should be relatively nice and easy
    train_vars.TrialsPerCondition = 50;
    train_vars.ControlProbability = 0;
    TrialsPerBlock = 50; 
    TotalNumBlocks = 3;
    % Repeats
    ...
    for BlockNo = 1:TotalNumBlocks
        ...
        [FixationXY, DotsXY, train_data, train_vars, train_schedule] = generate_stimuli(TrialsPerBlock, train_vars, train_params, train_option, train_data, participant); % Generate stimuli
